<script>
  ...
  $: if (pickerTarget) {
    pickerTarget.appendChild(emojiPicker);
  }
</script>
...
<input class="border border-gray-400" bind:value={message} />
...
<Popover class="border-none bg-transparent bg-none" trigger="click" triggeredBy="#button">
  <div class="bg-transparent" bind:this={pickerTarget}></div>
</Popover>
