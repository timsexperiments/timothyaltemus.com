...
export const AvatarIcon = ({ avatar, size = 'md' }: AvatarIconProps) => {
  const cssSize = sizeToCssSize[size];
  if (avatar === 'astronaut') {
    <svg
      className={cssSize}
      fill="currentColor"
